...
class TestTimezones:
    def test_utc(self):
        ...
        assert '<tzinfo: UTC>' == repr(datetimeutil.utc)
    ...
    def test_fixed_timezone(self):
        ...
        assert "<tzinfo '10:30' datetime.timedelta(0, 37800)>" == repr(target)
...
class TestParseIsoDateString:
    ...
    def test_valid_values(self, value):
        assert datetime.date(2014, 1, 13) == datetimeutil.parse_iso_date(value)
...
class TestParseIsoTimeString:
    ...
    def test_valid_values(self, value, expected):
        assert datetimeutil.parse_iso_time(value) == expected
    ...
    def test_valid_values_timezone_handling(self, value, default_tz, expected):
        assert datetimeutil.parse_iso_time(value, default_tz) == expected
...
class TestParseIsoDateTimeString:
    ...
    def test_valid_values(self, value, expected):
        assert datetimeutil.parse_iso_datetime(value) == expected
    ...
    def test_valid_values_timezone_handling(self, value, default_tz, expected):
        assert datetimeutil.parse_iso_datetime(value, default_tz) == expected
...
class TestToDateString:
    ...
    def test_aware_datetime(self):
        ...
        actual = datetimeutil.to_ecma_datetime(dt, datetimeutil.utc)
        assert "2013-07-13T16:54:46.123Z" == actual
...
class TestParseHttpDateString:
    ...
    def test_valid_values(self, value, expected):
        assert datetimeutil.parse_http_datetime(value) == expected
...
class TestToHttpDateString:
    ...
    def test_valid_values(self, value, expected):
        assert datetimeutil.to_http_datetime(value) == expected
